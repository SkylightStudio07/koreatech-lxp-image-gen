...
학교·Microsoft의 공식 확장이 아닙니다. 현재 배포 버전은 **School Code 0.18.7**, **Chrome Connector 0.3.0**입니다.
...
| 파일 | 용도 |
|---|---|
| `school-code-0.18.7.vsix` | VS Code 확장 설치 |
...
1. 최신 릴리즈에서 `school-code-0.18.7.vsix`를 내려받습니다.
...
git commit -m "docs: publish School Code 0.18.7 release guide"
git push origin master
gh release create v0.18.7 `
  tools/school-code/school-code-0.18.7.vsix `
  tools/school-code/school-code-connector-0.3.0.zip `
  tools/school-code/SHA256SUMS.txt `
  --title "School Code 0.18.7" `
