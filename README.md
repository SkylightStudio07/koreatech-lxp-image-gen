...
학교·Microsoft의 공식 확장이 아닙니다. 현재 배포 버전은 **School Code 0.20.0**, **Chrome Connector 0.3.0**입니다.
...
| 파일 | 용도 |
|---|---|
| `school-code-0.20.0.vsix` | VS Code 확장 설치 |
...
1. 최신 릴리즈에서 `school-code-0.20.0.vsix`를 내려받습니다.
