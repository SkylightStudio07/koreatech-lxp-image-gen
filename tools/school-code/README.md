...
일반 사용자는 저장소를 내려받아 빌드하지 말고 GitHub Release에서 `school-code-0.18.3.vsix`와 `school-code-connector-0.3.0.zip`을 설치하세요. 이 문서는 기능·운영·개발 세부사항을 위한 문서이며, 구성원용 순서도는 저장소 루트의 [forBCSD.md](https://github.com/SkylightStudio07/koreatech-lxp-image-gen/blob/master/forBCSD.md)를 따릅니다.
...
1. VS Code에 `school-code-0.18.3.vsix`를 설치합니다.
